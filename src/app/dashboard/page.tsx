      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <h1 className="text-4xl font-bold text-white">Página inicial</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-gray-900 rounded-2xl border border-gray-800 p-6 shadow-xl">
            <div className="flex items-center gap-3 mb-4">
              ...
              <p className="text-white text-lg font-semibold">Receitas</p>
            </div>
          ...
          <div className="bg-gray-900 rounded-2xl border border-gray-800 p-6 shadow-xl">
            <div className="flex items-center gap-3 mb-4">
              ...
              <p className="text-white text-lg font-semibold">Despesas</p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-10">
          <div className="bg-gray-900 rounded-2xl border border-gray-800 p-6 shadow-xl">
            ...
            {visibleWeekPayables.length === 0 ? (
              ...
              <div className="space-y-3">
                {visibleWeekPayables.map((b) => (
                  <div
                    key={b.id}
                    className="flex items-center justify-between gap-4 border border-gray-800 rounded-xl px-4 py-4 bg-gray-950/40 hover:border-gray-700 transition"
                  >
            ...
            <div className="mt-4 flex justify-end">
              <Button asChild className="bg-gray-800 hover:bg-gray-700 text-white rounded-xl">
