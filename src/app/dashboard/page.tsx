...
import { ArrowDownCircle, ArrowUpCircle, CalendarClock, Sparkles, Wallet } from 'lucide-react'
      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6">
        <section className="mb-8 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <h1 className="text-3xl font-bold text-white sm:text-4xl">Página inicial</h1>
        ...
        <section className="mb-8 grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-3">
          ...
          <AppStatCard
            ...
            icon={Wallet}
            valueClassName={currentMonthSummary.balance >= 0 ? 'text-amber-400' : 'text-red-400'}
          />
        </section>
        ...
        <section className="mb-8 grid grid-cols-1 gap-6 lg:grid-cols-2">
          <div className="premium-panel p-6">
                ...
                {weekPayables.map((bill) => (
                  ...
                  >
                    ...
                    <div className="text-right">
                      ...
                      <div className="mt-2 text-xs text-amber-400">pendente</div>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="mt-5 flex justify-end">
              <Button asChild className="premium-button-secondary px-4 py-2.5 text-sm">
                ...
                {weekReminders.map((r) => (
                  ...
                  >
                    <div className="min-w-0">
                      ...
                      {r.description ? (
                        <div className="mt-1 truncate text-xs text-slate-500">{r.description}</div>
                      ) : null}
                    </div>
